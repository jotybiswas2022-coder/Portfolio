...
@section('title', 'Terms of Services — Core Trading Solutions')
        ...
        <div style="display:grid;grid-template-columns:1fr;gap:2rem">
            ...
            <div style="display:flex;flex-direction:column;gap:2.5rem;color:#9ca3af;font-size:0.875rem;line-height:1.7">
                <section id="section-1" class="reveal">
                    ...
                    <p>These Terms of Services govern your use of the Core Trading Solutions website and the purchase and use of our Expert Advisors. By accessing our website and purchasing our products, you agree to be bound by these terms.</p>
                ...
                <section id="section-4" class="reveal stagger-3">
                    ...
                    <p>All Expert Advisors, source codes, and related materials provided by Core Trading Solutions are protected by copyright and intellectual property laws. You are granted a license to use the products for personal trading purposes only.</p>
                    <p style="margin-top:0.5rem">You may not distribute, resell, or share your licensed products with third parties without explicit written permission from Core Trading Solutions.</p>
                </section>
                <section id="section-5" class="reveal stagger-4">
                    ...
                    <p>Core Trading Solutions provides trading tools and software as-is. We do not guarantee profitability or specific trading results. Trading Forex and other financial instruments carries significant risk.</p>
                ...
                <section id="section-6" class="reveal stagger-5">
                    ...
                    <p>These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which Core Trading Solutions operates, without regard to its conflict of law provisions.</p>
