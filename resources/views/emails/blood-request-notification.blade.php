...
<head>
    ...
    <title>{{ __('জরুরি রক্তের প্রয়োজন') }}</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 30px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="background:linear-gradient(135deg,#dc2626,#ef4444);padding:30px 30px 24px;text-align:center;">
                            ...
                            <h1 style="color:#fff;font-size:22px;font-weight:800;margin:0 0 6px;letter-spacing:-0.3px;">🚨 {{ __('জরুরি রক্তের প্রয়োজন!') }}</h1>
                            <p style="color:rgba(255,255,255,0.8);font-size:14px;margin:0;line-height:1.5;">
                                <strong style="color:#fff;">{{ $bloodRequest->blood_group }}</strong> {{ __('ব্লাড গ্রুপের একজন রোগীর জরুরি রক্ত প্রয়োজন') }}
                            </p>
                        </td>
                    </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding-bottom:16px;">
                                        <h2 style="font-size:18px;font-weight:700;color:#1f2937;margin:0 0 4px;">{{ __('প্রিয়') }} {{ $donorProfile->name }},</h2>
                                        <p style="font-size:14px;color:#6b7280;line-height:1.7;margin:0;">
                                            {{ __('আপনার ব্লাড গ্রুপের সাথে মিলে যাওয়া একটি জরুরি রক্তের অনুরোধ এসেছে। নিচের তথ্য দেখে দ্রুত যোগাযোগ করার জন্য অনুরোধ করা যাচ্ছে।') }}
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="padding:14px 18px;background:#fef2f2;border-radius:12px;border-left:4px solid #dc2626;">
                                        <table width="100%" cellpadding="4" cellspacing="0">
                                            <tr>
                                                <td width="120" style="font-size:13px;color:#6b7280;font-weight:600;">{{ __('রোগীর নাম') }}</td>
                                                <td style="font-size:14px;color:#1f2937;font-weight:700;">{{ $bloodRequest->patient_name }}</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size:13px;color:#6b7280;font-weight:600;">{{ __('প্রয়োজনীয় রক্ত') }}</td>
                                                <td style="font-size:16px;color:#dc2626;font-weight:800;">{{ $bloodRequest->blood_group }}</td>
                                            </tr>
                                            <tr>
                                                <td style="font-size:13px;color:#6b7280;font-weight:600;">{{ __('অবস্থান') }}</td>
                                                <td style="font-size:14px;color:#1f2937;font-weight:600;">{{ $bloodRequest->location }}</td>
                                            </tr>
                                            @if($bloodRequest->hospital)
                                            <tr>
                                                <td style="font-size:13px;color:#6b7280;font-weight:600;">{{ __('হাসপাতাল') }}</td>
                                                <td style="font-size:14px;color:#1f2937;font-weight:600;">{{ $bloodRequest->hospital }}</td>
                                            </tr>
                                            @endif
                                            <tr>
                                                <td style="font-size:13px;color:#6b7280;font-weight:600;">{{ __('যোগাযোগ') }}</td>
                                            ...
                                            <tr>
                                                <td style="font-size:13px;color:#6b7280;font-weight:600;">{{ __('বার্তা') }}</td>
                                    ...
                                    <td align="center">
                                        @php
                                            $urgencyBadge = match($bloodRequest->urgency) {
                                                'critical' => '🔴 '.__('ক্রিটিক্যাল - অবিলম্বে প্রয়োজন'),
                                                'urgent' => '🟡 '.__('জরুরি - দ্রুত প্রয়োজন'),
                                                default => '🔵 '.__('সাধারণ - প্রয়োজন রয়েছে'),
                                            };
                                        @endphp
                                ...
                                <tr>
                                    <td style="padding:16px 0 0;border-top:1px solid #f3f4f6;">
                                        <p style="font-size:12px;color:#9ca3af;line-height:1.6;margin:0;text-align:center;">
                                            {{ __('একটি জীবন বাঁচান - আপনার এক ফোঁটা রক্ত কারো জন্য হতে পারে নতুন জীবনের আশীর্বাদ।') }}<br>
                                            {{ __('রক্তদানের পর কমপক্ষে') }} <strong>{{ __('৯০ দিন') }}</strong> {{ __('অপেক্ষা করতে হবে।') }}
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="background:#f8f9fa;padding:16px 30px;text-align:center;border-top:1px solid #f3f4f6;">
                            <p style="font-size:11px;color:#9ca3af;margin:0;">
                                {{ __('ব্লাড ব্যাংক') }} &copy; {{ date('Y') }} &middot; {{ __('রক্তদান · জীবন বাঁচান') }}
                            </p>
                        </td>
                    </tr>
                </table>
