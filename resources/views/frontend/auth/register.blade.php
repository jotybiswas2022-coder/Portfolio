    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .login-card::before {
        ...
        background: linear-gradient(135deg,
            ...
            rgba(139,92,246,0.15) 50%, rgba(59,130,246,0.15) 75%, transparent 100%);
    ...
    .login-input:focus {
        ...
        box-shadow: 0 0 0 4px rgba(59,130,246,0.12), 0 0 20px rgba(59,130,246,0.05);
    }
    ...
    .password-toggle:hover { color: var(--login-accent-light); background: rgba(59,130,246,0.08); }
    ...
    .login-btn:hover {
        transform: translateY(-2px);
        box-shadow: 0 12px 35px rgba(59,130,246,0.4), 0 0 20px rgba(59,130,246,0.15);
    }
    ...
    .signup-btn {
        ...
        border: 1.5px solid rgba(59,130,246,0.3); color: var(--login-accent-light);
        font-size: 14px; font-weight: 600; text-decoration: none;
        transition: all 0.25s ease; background: rgba(59,130,246,0.05);
    }
    .signup-btn svg { width: 16px; height: 16px; transition: transform 0.25s ease; }
    .signup-btn:hover {
        background: rgba(59,130,246,0.12); border-color: var(--login-accent);
    ...
    @media (max-width: 576px) {
        ...
        .login-card { max-width: 100%; border-radius: 0; min-height: 100dvh; background: rgba(10,15,30,0.95); backdrop-filter: none; -webkit-backdrop-filter: none; border: none; box-shadow: none; display: flex; flex-direction: column; }
    ...
    .login-container ::-webkit-scrollbar-thumb { background: rgba(59,130,246,0.25); border-radius: 10px; }
    .login-container ::-webkit-scrollbar-thumb:hover { background: rgba(59,130,246,0.4); }
