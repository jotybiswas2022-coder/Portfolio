...
<head>
    ...
    html.light-theme .header-icon svg { stroke: #3b82f6 !important; }
    ...
    html.light-theme .login-input:focus { border-color: #3b82f6 !important; }
    ...
    .particle { position:absolute; border-radius:50%; background: rgba(59,130,246,0.4); animation: floatUp linear infinite; }
    ...
    .login-card {
        ...
        backdrop-filter: blur(28px); border:1px solid rgba(59,130,246,0.2);
    ...
    .header-icon { width:50px; height:50px; background: linear-gradient(135deg,#3b82f6,#2563eb); border-radius:16px; display:flex; align-items:center; justify-content:center; box-shadow:0 12px 35px rgba(59,130,246,0.4); transition: all 0.3s ease; }
    ...
    .verify-icon { width:72px; height:72px; background: rgba(59,130,246,0.1); border:2px solid rgba(59,130,246,0.2); border-radius:50%; display:flex; align-items:center; justify-content:center; color:#3b82f6; animation: verifyPulse 2s ease-in-out infinite; transition: transform 0.3s ease; }
    .verify-icon:hover { transform:scale(1.08); }
    .verify-icon svg { width:32px; height:32px; }
    @keyframes verifyPulse { 0%,100% { box-shadow: 0 0 0 0 rgba(59,130,246,0.3); } 50% { box-shadow: 0 0 0 12px rgba(59,130,246,0); } }
    ...
    .login-btn { background: linear-gradient(135deg,#3b82f6,#2563eb); border:none; color:#fff; padding:14px 24px; font-size:15px; border-radius:32px; font-weight:600; width:100%; display:flex; align-items:center; justify-content:center; gap:8px; transition:all 0.3s ease; }
    .login-btn:hover { transform:scale(1.03); box-shadow:0 12px 28px rgba(59,130,246,0.45); }
