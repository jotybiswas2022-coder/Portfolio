        ...
        <div class="col-lg-8 col-md-10">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
                <h5 class="fw-bold mb-0" style="font-size:0.95rem;">
                    <i class="bi bi-pencil-square me-2" style="color:#6366f1;"></i>Edit Case Study
                </h5>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" id="technologies" name="technologies"
                                       ...
                                       value="{{ old('technologies', $caseStudy->technologies) }}" placeholder="e.g. Laravel, React, AWS, Docker">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="url" id="url" name="url"
                                       ...
                                       value="{{ old('url', $caseStudy->url) }}" placeholder="https://...">
                    ...
                    <div class="card-body px-4 py-3">
                        ...
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <div class="flex-grow-1">
                                ...
                                @if($caseStudy->image)
                                    <div class="mt-2">
                                        <button type="button" onclick="confirmDeleteImage()" class="btn-img-remove">
