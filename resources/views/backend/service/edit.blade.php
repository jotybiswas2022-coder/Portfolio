        ...
        <div class="col-lg-8 col-md-10">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
                <h5 class="fw-bold mb-0" style="font-size:0.95rem;">
                    <i class="bi bi-pencil-square me-2" style="color:#6366f1;"></i>Edit Service
                </h5>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea id="short_description" name="short_description" rows="4"
                                          ...
                                          placeholder="Brief description for the service card (max 500 characters)">{{ old('short_description', $service->short_description) }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div class="icon-preview-box">
                                        <i class="bi {{ old('icon', $service->icon) ?: 'bi-star' }}" id="iconPreview"></i>
                                    </div>
                                </div>
