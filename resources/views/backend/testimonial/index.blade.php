...
@if (session('success'))
    <div class="alert alert-success alert-dismissible fade show mx-3 mt-3 shadow-sm rounded-3" role="alert" style="border-radius: 12px; font-size: 14px;">
    ...
    <div class="container-fluid px-0">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2 mt-2 mt-md-0">
                <span class="badge px-3 py-2" style="background: rgba(99,102,241,0.1); color: #6366f1; font-weight: 600; border-radius: 20px; font-size: 0.82rem;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span style="color: #64748b; font-size: 0.85rem;">
                                            {{ $testimonial->designation_display ?: '—' }}
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        <span class="badge-admin" style="background: rgba(99,102,241,0.08); color: #6366f1;">
